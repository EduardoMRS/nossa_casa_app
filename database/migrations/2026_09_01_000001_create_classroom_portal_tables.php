...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (! Schema::hasTable('classroom_activities')) {
        ...
        if (! Schema::hasTable('classroom_activity_submissions')) {
        ...
        if (! Schema::hasTable('classroom_materials')) {
        ...
        if (! Schema::hasTable('classroom_discussions')) {
        ...
        if (! Schema::hasTable('classroom_discussion_replies')) {
