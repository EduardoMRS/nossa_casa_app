...
class UpdateChurchSettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'default_locale' => ['sometimes', 'nullable', Rule::in((array) config('app.locales', ['en', 'pt']))],
            ...
            'address' => [
                'nullable',
                'array:country,state,city,neighborhood,street,number,complement,zipcode,latitude,longitude',
            ],
            'address.country' => ['nullable', 'string', 'max:120'],
            'address.state' => ['nullable', 'string', 'max:120'],
            'address.city' => ['nullable', 'string', 'max:160'],
            'address.neighborhood' => ['nullable', 'string', 'max:160'],
            'address.street' => ['nullable', 'string', 'max:255'],
            'address.number' => ['nullable', 'string', 'max:60'],
            'address.complement' => ['nullable', 'string', 'max:255'],
            'address.zipcode' => ['nullable', 'string', 'max:40'],
            'address.latitude' => [
                'nullable',
                'numeric',
                'between:-90,90',
                'required_with:address.longitude',
            ],
            'address.longitude' => [
                'nullable',
                'numeric',
                'between:-180,180',
                'required_with:address.latitude',
            ],
