...
<template>
    <Head title="Minhas salas" />
    <div class="flex min-h-screen flex-col bg-slate-50">
        <PublicHeader />
        <main class="mx-auto w-full max-w-6xl flex-1 px-4 py-10">
            <div class="mb-8">
                <p class="text-xs font-black tracking-[.22em] text-indigo-600 uppercase">Classroom</p>
                <h1 class="mt-2 text-3xl font-black text-slate-950 md:text-5xl">Minhas salas</h1>
                <p class="mt-3 text-slate-600">Atividades, conversas e materiais reunidos em um só lugar.</p>
            </div>
            ...
            <p v-else class="rounded-3xl border border-dashed border-slate-300 bg-white p-12 text-center text-slate-500">Você ainda não participa de uma sala.</p>
        </main>
