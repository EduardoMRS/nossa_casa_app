...
- [x] Mover salvamento das midias em geral para que sejam salvas no storage, creio já estar assim mas verifique, o acesso e visualização de arquivos será apenas via url ecriptadapara maior segurança
- [x] Worker que recebe RTSPs para transmissão ao vivo de video/audio
